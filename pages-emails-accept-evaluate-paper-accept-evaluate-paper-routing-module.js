(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-emails-accept-evaluate-paper-accept-evaluate-paper-routing-module"],{
...
class AcceptEvaluatePaperComponent {
    ...
    ngOnInit() {
        ...
        this.service.acceptEvaluatePaper('?token=' + this.token).subscribe((res) => this.accepted = true, (err) => { alert('No se pudo aceptar la evaluación del paper.'); });
    }
}
...
//# sourceMappingURL=pages-emails-accept-evaluate-paper-accept-evaluate-paper-routing-module.js.map