(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-emails-accept-evaluator-accept-evaluator-routing-module"],{
...
class AcceptEvaluatorComponent {
    ...
    ngOnInit() {
        ...
        this.service.acceptEvaluator('?token=' + this.token).subscribe((res) => this.accepted = true, (err) => { alert('No se pudo confirmar su rol como evaluador.'); });
    }
}
...
//# sourceMappingURL=pages-emails-accept-evaluator-accept-evaluator-routing-module.js.map