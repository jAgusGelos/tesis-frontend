(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-emails-cancel-evaluate-paper-cancel-evaluate-paper-routing-module"],{
...
class CancelEvaluatePaperComponent {
    ...
    ngOnInit() {
        ...
        this.service.cancelEvaluatePaper('?token=' + this.token).subscribe((res) => this.cancel = true, (err) => { alert('No se pudo cancelar su asignación como evaluador del paper.'); });
    }
}
...
//# sourceMappingURL=pages-emails-cancel-evaluate-paper-cancel-evaluate-paper-routing-module.js.map